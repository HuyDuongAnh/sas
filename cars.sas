/* From the car data, print the car price that is in a specfic range
*/
%let min_range=20000;
%let max_range=40000;
...
proc print data=sashelp.cars;
	var MSRP Make Model;
	where MSRP >= &min_range and MSRP <= &max_range;
run;
...
*proc means data=sashelp.cars min mean max maxdec=0;       /* 7 */
*    var MSRP;                                      /* 8 */
*    class Type;                                           /* 9 */
