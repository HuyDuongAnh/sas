...
%let outpath = /home/u63733914/Output;
...
/* REPORT   */
/************/
ods proclabel="List of &carMake Cars";
...
proc print data=sashelp.cars contents='List';
	id Model;
	var Type Origin MSRP Invoice EngineSize Cylinders Horsepower MPG_City 
		MPG_Highway;
	where Make="&carMake";
	quit;
	title;
	...
	/* VISUALIZATION */
	/*****************/
	ods proclabel="MPG by MSRP for &carMake";
